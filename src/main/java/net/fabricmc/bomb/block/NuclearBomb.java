...
public class NuclearBomb extends BombBlock {
    public static final BooleanProperty UNSTABLE = Properties.UNSTABLE;

    public NuclearBomb(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        NuclearBombEntity entity = new NuclearBombEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public void primeExplosion(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        NuclearBombEntity entity = new NuclearBombEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(entity);
