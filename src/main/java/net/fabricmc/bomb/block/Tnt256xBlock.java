...
public class Tnt256xBlock extends BombBlock {
    public static final BooleanProperty UNSTABLE = Properties.UNSTABLE;

    public Tnt256xBlock(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        Tnt256xEntity entity = new Tnt256xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public void primeExplosion(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        Tnt256xEntity entity = new Tnt256xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(entity);
