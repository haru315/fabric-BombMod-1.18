...
import net.fabricmc.bomb.entity.HyperNovaEntity;
...
public class HyperNovaBlock extends BombBlock {
    public static final BooleanProperty UNSTABLE = Properties.UNSTABLE;

    public HyperNovaBlock(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        HyperNovaEntity entity = new HyperNovaEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public void primeExplosion(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        HyperNovaEntity entity = new HyperNovaEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(entity);
