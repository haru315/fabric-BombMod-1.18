...
public class Tnt16384xBlock extends BombBlock {
    public static final BooleanProperty UNSTABLE = Properties.UNSTABLE;

    public Tnt16384xBlock(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        Tnt16384xEntity entity = new Tnt16384xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public void primeExplosion(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        Tnt16384xEntity entity = new Tnt16384xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(entity);
