...
public class Tnt4096xBlock extends BombBlock {
    public static final BooleanProperty UNSTABLE = Properties.UNSTABLE;

    public Tnt4096xBlock(Settings settings) {
        super(settings);
    ...
    public void onDestroyedByExplosion(World world, BlockPos pos, Explosion explosion) {
        ...
        Tnt4096xEntity entity = new Tnt4096xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, explosion.getCausingEntity());
    ...
    public void primeExplosion(World world, BlockPos pos, @Nullable LivingEntity igniter) {
        ...
        Tnt4096xEntity entity = new Tnt4096xEntity(world, (double)pos.getX() + 0.5, pos.getY(), (double)pos.getZ() + 0.5, igniter);
        world.spawnEntity(entity);
