...
public class NukeExplosionEntity extends Entity {
    ...
    public int length;
/*
    public NukeExplosionEntity(World world) {
        this(BombMod.NUKE_EXPLOSION_ENTITY, world);
    }
*/
    public NukeExplosionEntity(EntityType<? extends NukeExplosionEntity> type, World world) {
        super(type, world);
    }
/*
    public NukeExplosionEntity(World world, double x, double y, double z) {
        this(BombMod.NUKE_EXPLOSION_ENTITY, world);
...
/*
    public static NukeExplosionEntity statFac(World world, double x, double y, double z, int r) {

        NukeExplosionEntity mk4 = new NukeExplosionEntity(world);
        mk4.strength = r;
