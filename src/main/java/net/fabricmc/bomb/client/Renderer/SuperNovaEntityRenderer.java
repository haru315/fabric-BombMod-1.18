...
public class SuperNovaEntityRenderer extends EntityRenderer<BombEntity> {

    public SuperNovaEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    ...
    public void render(BombEntity Entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        matrixStack.multiply(Vec3f.POSITIVE_Y.getDegreesQuaternion(90.0f));
        TntMinecartEntityRenderer.renderFlashingBlock(BombMod.SUPER_NOVA_BLOCK.getDefaultState(), matrixStack, vertexConsumerProvider, i, j / 5 % 2 == 0);
        matrixStack.pop();
